...
`lumen-core` (for the default theme color).
...
## Common patterns
```ignore
ui.add(lumen_icons::Icon::search());
ui.add(lumen_icons::Icon::close().size(20.0).color(egui::Color32::RED));
```
