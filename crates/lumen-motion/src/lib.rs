//! `lumen-motion` — animation engine for lumen-ui: spring physics, easings, and
//! (from v0.5 slice 2) transitions.
//!
//! Enable via the `motion` feature of the `lumen-ui` façade. This is the richer
//! counterpart to `lumen-core::anim` (the dependency-free minimal motion used by
//! widgets): same call-site shape, spring/easing-backed implementation (ADR-0003).
//!
//! ```ignore
//! use eframe::egui;
//! use lumen_motion::{Spring, ease, Easing};
//!
